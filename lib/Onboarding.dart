    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text("Lorem ipsum is simply dummy text of printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text.", style: TextStyle(
            fontSize: 16,
            color: Colors.grey
